...
@Component({
    selector: 'jhi-order-main-my-suffix-update',
    templateUrl: './order-main-my-suffix-update.component.html'
})
export class OrderMainMySuffixUpdateComponent implements OnInit {
